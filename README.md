# สถิติ
<header ><h4 align="center">การหาค่าทางสถิติหาได้ทั้ง 2 แบบคือ แบบแจกแจงความถี่ และ แบบไม่แจกแจกความถี่</h4></header>

> ตัวโปรแกรมนั้นยังมีบัคมี error อยู่บ้างถ้าหากใส่ข้อมูลไปแล้วได้คำตอบเป็น undefined หรือ NaN ก็แปลว่ายังไม่ได้แก้ไขบัคในส่วนตรงนั้น
