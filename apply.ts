...
export class my_stats {
    ...
    public W:number[];
        ...
        public Mode = (Mode:number = 0 , count:any = {} , max:number = 0 , x:number[] = this.sortdata , f:number[] = this.frequency , n:number = this.n() , d1:number = 0 , d2:number = 0  , l:number = 0 , i:number  = this.I) => {
            if(x.length > 0 && f.length === 0){
                let Mo:string[] = []; 
        ...
        public Harmonic_mean = (HM:number = 0 ,  x:number[] = this.data , n:number = this.data.length , Σx:number = 0 , f:number[] = this.frequency , Σx2:number = 0):number => {
            if(f.length === 0){
        ...
        public Pr = (r:number = 0 , Pr:number = 0 , position_Pr:number = 0 , x:number[] = this.sortdata , n:number = this.n() , f:number[] = this.frequency , l:number = 0 , i:number  = this.I , Σfl:number = 0 , fp:number = 0):(string|number) => {
                ...
                position_Pr = r *(n + 1) / 100;
                    if(x.length > 0 && Number.isInteger(position_Pr) && f.length !== 0 ) {
                        ...
                        let difference:number = position_Pr - Math.trunc(position_Pr);
    ...
    public Quartile_deviation = (QD:number = 0 , Q1:number = 1 , Q3:number = 3  ,  n:number = this.n() , position_Qr:number[] = this.sortdata , f:number[] = this.frequency , l1:number = 0 , i1:number  = this.I , Σfl1:number = 0 , fq1:number = 0 , l3:number = 0 , i3:number  = this.I , Σfl3:number = 0 , fq3:number = 0 , x:number[] = this.sortdata):number => {
        if(f.length === 0){
            ...
            if(this.cumulative_frequency.map((w:number) => w === Math.round(Position.Q1)) || this.cumulative_frequency.map((p:number) => p === Math.round(Position.Q3))){
                ...
                if(l1 === undefined || l1 === null) l1 = 0;
                if(l3 === undefined || l3 === null) l3 = 0;      
                if(Σfl1  === undefined || Σfl1 === null) Σfl1 = 0;
                if(Σfl3  === undefined || Σfl3 === null) Σfl3 = 0;                                    
