...
/*
    ...
    - สิ่งที่ต้องติดตั้งก่อนนำมาใช้งาน 
        1.) ติดตั้ง Nodejs ลงบนเครื่องแนะนำให้ติดตั้ง version ชั้นเก่า   link => nodejs.org
    ...
    - การใช้งาน
            ...
            11.) แสดงผลลัพธ์ข้อมูลที่ได้ผ่านใน termianl คำสั่ง: console.log(....)
                                                                        ...
                                                                        - ผู้เขียนคู่มือนี้ลงชื่อ วรินทร์ 
*/

/* รวมคำสั่งการใช้งานสถิติทั้งหมด */
/* คำสั่งทั้งหมดนี้จะหาทั้ง 2รูปแบบคือ { แบบแจกแจงข้อมูล } และ { แบบไม่แจกแจงข้อมูล } จะหาแบบไหนขึ้นอยู่กับการใส่ข้อมูลลงไปและใส่ให้ถูกต้อง */
